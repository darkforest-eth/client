...
const round1EndTimestamp = '2021-06-06T21:00:00-07:00';
const round1EndTime = new Date(round1EndTimestamp).getTime();

function CountDown() {
  const [str, setStr] = useState('');

  const update = () => {
    const timeUntilEndms = round1EndTime - new Date().getTime();
    if (timeUntilEndms <= 0) {
      setStr('yes');
    } else {
