...
import { getGlassProgramAndUniforms, glassPosProps, glassTexProps } from '../Programs/GlassProgram';
import { GLASS_URL, loadSprite } from '../TextureManager';
...
export class GlassRenderer {
  ...
  private async setup() {
    const img = await loadSprite(GLASS_URL);
