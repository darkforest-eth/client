...
// import { artifactName } from '../../src/Backend/Procedural/ArtifactProcgen';
import { ProcgenUtils } from '../../src/Backend/Procedural/ProcgenUtils';
import { Chunk } from '../../src/_types/global/GlobalTypes';
import Viewport from '../../src/Frontend/Game/Viewport';
import dfstyles from '../../src/Frontend/Styles/dfstyles';
// import { useUIManager } from '../../src/Frontend/Utils/AppHooks';
import { BLOCK_EXPLORER_URL } from '../../src/Frontend/Utils/constants';
...
export function PlanetNameLink({ planet }: { planet: Planet }) {
  return <CenterPlanetLink planet={planet}>{df.getProcgenUtils().getPlanetName(planet)}</CenterPlanetLink>;
}
