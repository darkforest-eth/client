...
import { CustomTowardsCenterPattern } from './miners/TowardsCenter'
...
function getPattern(coords, patternType, chunkSize) {
  if (patternType === 'swiss') {
    ...
    return new CustomTowardsCenterPattern(coords, chunkSize);
  }
}
...
class RemoteExplorerPlugin {
  ...
  constructor() {
    ...
    this.addMiner('http://craigs-mac-mini.local:8000/mine', 'towardsCenter', 256);
  }
